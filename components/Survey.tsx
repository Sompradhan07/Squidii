...
const questions: Question[] = [
  ...
  },
  {
    ...
    opts: [
      ...
      { v: '3-4',    l: '3 to 4 days', icon: ic.barbell },
      { v: '1-2',    l: '1 to 2 days', icon: ic.wave    },
  ...
  },
  {
    ...
    opts: [
      ...
      { v: 'recomp',    l: 'Body recomposition', icon: ic.target  },
  ...
  },
  {
    ...
    opts: [
      { v: '200-300',   l: '₹200 to 300', icon: ic.rupee   },
      { v: '300-400',   l: '₹300 to 400', icon: ic.card    },
      { v: '400plus',   l: '₹400+',       icon: ic.diamond },
      { v: 'no-online', l: 'I don’t order online', icon: ic.moon },
    ],
  },
  {
